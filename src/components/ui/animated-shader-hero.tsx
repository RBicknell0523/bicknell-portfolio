  ...
  return (
    <div id="hero" className={`relative w-full min-h-[100svh] ${className}`}>
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse 80% 60% at 50% 45%, rgba(0,0,0,0.45) 0%, transparent 75%)" }}
      />

      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white pt-16 lg:pt-0">
        {trustBadge && (
