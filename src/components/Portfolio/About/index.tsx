...
const skills = [
  "React", "Next.js", "Node.js", "JavaScript", "HTML5", "CSS3", "Sass/SCSS",
  "Tailwind CSS", "Redux", "MySQL", "Git", "GitHub", "Responsive Web Design",
  "Database Management", "Test-Driven Development (TDD)", "Error Handling", "Web Deployment",
];
...
const expEduItems: BentoItem[] = [
  {
    title: "U.S. Army",
    meta: "Sept 2019 – Jan 2026",
    description: "Noncommissioned Officer · Medical Supervisor · Fort Riley, KS",
  ...
  },
  {
    ...
    description:
      "Full-stack web development training covering front-end, back-end, database design, API integration, and responsive applications.",
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-[auto_1fr]">
          ...
          <div className="flex flex-col items-center gap-5 lg:items-start">
            ...
            <div className="flex gap-3">
              <a href="https://github.com/RBicknell0523" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
              ...
              <a href="https://www.linkedin.com/in/robert-bicknell-81b04440b/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                className="text-muted-foreground transition-colors hover:text-primary">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="mb-4 flex justify-center gap-2 lg:justify-start">
              {(["stack", "certs"] as Tab[]).map((t) => (
                <button
                  key={t}
                  onClick={() => setTab(t)}
                  className={`rounded-md border px-3 py-1.5 text-xs font-semibold uppercase tracking-widest transition-all duration-200 ${
                    tab === t
            ...
            <div className="relative min-h-[96px]">
              ...
              <div
                className={`flex flex-wrap justify-center gap-2 transition-opacity duration-300 lg:justify-start ${
                  tab === "stack" ? "opacity-100" : "pointer-events-none absolute inset-0 opacity-0"
                }`}
              >
                {skills.map((skill) => (
              ...
              <div
                className={`flex flex-col gap-3 transition-opacity duration-300 ${
                  tab === "certs" ? "opacity-100" : "pointer-events-none absolute inset-0 opacity-0"
                }`}
              >
                {certifications.map((cert) => (
                  <div key={cert.name} className="flex items-center gap-3">
                    ...
                    <span className={`text-sm font-medium ${cert.status === "earned" ? "text-foreground" : "text-muted-foreground"}`}>
                      {cert.name}
                    </span>
                    {cert.status === "pending" && (
